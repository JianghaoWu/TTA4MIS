...
# ----------------------------- Model options ------------------------------- #
_C.SOURCE = CfgNode()
_C.SOURCE.MAX_EPOCHES = 400
_C.SOURCE.BATCH_SIZE = 12
_C.SOURCE.EVAL_ITERS = 1000
_C.SOURCE.SOURCE_DOMAIN = 'A'
_C.SOURCE.ALL_DOMAIN = ['A','B','C','D']
_C.SOURCE.TARGET_DOMAIN = ['B','C','D']
# ----------------------------- Model options ------------------------------- #
_C.MODEL = CfgNode()
...
_C.MODEL.METHOD = 'source'
_C.MODEL.NETWORK = 'unet2d'
_C.MODEL.CKPT_DIR = '../save_model'
_C.MODEL.DATASET = 'mms'
_C.MODEL.NUMBER_CLASS = 2
_C.MODEL.EXPNAME = 'sr'
_C.MODEL.NUM_DEC = 5
_C.ADAPTATION = CfgNode()
_C.ADAPTATION.TARGET = 'B'
_C.ADAPTATION.NUMBER_CLASS = 2
_C.ADAPTATION.BATCH_SIZE = 1
_C.ADAPTATION.EPOCH = 2
_C.ADAPTATION.TARGET_DOMAIN = ['B','C','D']
